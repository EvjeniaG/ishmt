/**
 * Politikat e afateve sipas Udhëzimit IQMT dhe rregullores së tregut.
...
/** Kontroll periodik: ndërtesa banimi / të tjera (muaj). */
export const INSPECTION_INTERVAL_MONTHS_DEFAULT = 12;

/** Kontroll periodik: vend pune, ndërtesë publike (muaj). */
export const INSPECTION_INTERVAL_MONTHS_WORKPLACE = 6;

/** Ditë paralajmërimi para skadimit të kontrollit periodik / certifikatës / kontratës. */
...
export const ISHMT_DEADLINE_PRINCIPLES = [
  ...
  "Kontrollet periodike: 6 muaj (vend pune / ndërtesë publike) ose 12 muaj (të tjera).",
  "IQMT kryen vlerësim periodik; ndryshimet ligjore reflektohen me amendamente.",
] as const;
