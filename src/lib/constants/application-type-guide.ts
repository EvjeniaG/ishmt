...
export const APPLICATION_TYPE_GUIDE: Record<ApplicationGuideKey, ApplicationGuideEntry> = {
  NEW_REGISTRATION: {
    ...
    tagline: "Për ashensor që regjistrohet për herë të parë pranë IQMT-së.",
    whenToUse:
    ...
    steps: [
      ...
      "Zgjidhni certifikuesin OM - ai plotëson certifikimin",
      "Parashtroni te IQMT - shqyrtim brenda 10 ditëve pune",
      "Pas miratimit: regjistrim në regjistrin CR dhe certifikatë e re",
    ],
    approvers: "Instalues · Certifikues · IQMT",
    outcome: "Ashensor i ri me numër regjistri dhe certifikatë CR.",
    legalRef: "Udhëzim IQMT p.6",
  },
  DATA_CORRECTION: {
    ...
    steps: [
      ...
      "Konfirmoni dhe parashtroni te IQMT (formular digjital)",
  ...
  DATA_UPDATE: {
    ...
    whenToUse:
      "Kur ndryshon adresa (nga organet kompetente), numri serial (pas OM), personi përgjegjës, mirëmbajtja ose kontaktet.",
  ...
  OWNERSHIP_TRANSFER: {
    ...
    legalRef: "Udhëzim IQMT p.15.c–16.c",
  },
  DEREGISTRATION: {
  ...
  MODERNIZATION: {
    ...
    legalRef: "Udhëzim IQMT p.15.c.iv",
  },
};
...
export const DATA_UPDATE_SUBTYPE_LABELS: Record<
  ...
  string
> = {
  SERIAL_NUMBER_CHANGE: "Ndryshim numri serial (pas OM)",
