...
import { ModernizationApplicationForm } from "@/components/owner/typed-application-forms";
...
export default async function ModernizationApplicationPage() {
  ...
  return (
    <AppShell title="Modernizim">
      ...
      >
        <SectionCard title="Formulari i modernizimit" padded>
          <div className="space-y-6">
            <ApplicationTypeGuide guideKey={ApplicationType.MODERNIZATION} compact />
            <ModernizationApplicationForm elevators={elevators.map((e) => ({ id: e.id, registryNumber: e.registryNumber, address: e.buildingAddress ?? "" }))} />
          </div>
        </SectionCard>
      </StandardPageLayout>
    </AppShell>
