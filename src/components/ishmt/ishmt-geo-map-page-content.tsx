...
export async function IshmtGeoMapPageContent({
  eyebrow,
  filters,
  mapBasePath = "/ishmt/chief/map",
}: {
  eyebrow: string;
  filters: GeoFilters;
  mapBasePath?: string;
  ...
  return (
    ...
    >
      ...
      <SectionCard title="Harta GIS" subtitle="Shpërndarja sipas vendndodhjes" padded>
      ...
      <SectionCard
        ...
        meta={<span className="portal-badge-neutral tabular-nums">{rows.length} bashki</span>}
      >
        {rows.length === 0 ? (
...
export function parseGeoMapFilters(params: Record<string, string | undefined>): GeoFilters {
  return {
