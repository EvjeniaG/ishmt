...
import { prefillInspectionAssignmentDemoAction } from "@/lib/actions/owner-actions";
import { isDemoToolsEnabled } from "@/lib/demo/demo-data-mode";

export function InspectionAssignmentDemoButton({ className = "" }: { className?: string }) {
  ...
  async function onClick() {
    ...
    const result = await prefillInspectionAssignmentDemoAction();
    setLoading(false);
    ...
    window.dispatchEvent(
      new CustomEvent("ishmt:inspection-demo-prefill", {
        detail: {
          orgId: result.orgId,
