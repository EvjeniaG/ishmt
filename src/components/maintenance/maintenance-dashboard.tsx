  ...
  return (
    ...
    >
      <div className="portal-kpi-grid">
        ...
        <MetricCard label="Raporte mujore të padorëzuara" value={data.cards.missingMonthlyReports} accent="warning" />
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Button asChild variant="outline"><Link href="/portal/sherbimi/raport-mujor">Raport mujor</Link></Button>
      ...
      <SectionCard title="Veprime të kërkuara" subtitle="Kontrata, ndërhyrje dhe raporte që presin veprim" padded>
